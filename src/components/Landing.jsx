...
const Landing = () => {
  return (
    <section
      className="w-[100%] md:h-screen h-[50%] md:px-20 bg-no-repeat bg-cover object-cover grid grid-cols-1 md:grid-cols-2"
      style={{ backgroundImage: `url(${HeroBG})` }}
    >
      <div className="py-32 md:text-left text-center md:px-0 px-5">
        <h1 className="text-10xl tracking-wide text-black md:block hidden">
        ...
        <div className="mt-4">
          <Link to="/all-courses">
            <button class="bg-transparent transition hover:duration-400 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-3 px-5 border border-blue-500 hover:border-transparent rounded">
              View Courses
            </button>
          </Link>
        </div>
